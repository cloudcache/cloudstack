    ...
    const updatePods = async () => {
        ...
        try {
            ...
            if (response.status === 'success' && response.data) {
                ...
                toast.error((response as any).message ?? 'An unknown error occurred while loading pods.');
            }
        } catch (ex) {
            console.error(ex);
                    ...
                    <div>
                        <TooltipProvider>
                            <Tooltip delayDuration={300}>
                                ...
                                <TooltipContent><p>Download Logs</p></TooltipContent>
                            </Tooltip>
                        </TooltipProvider>
                    </div>
                    <div>
                        <Tooltip delayDuration={300}>
                            ...
                            <TooltipContent><p>Fullscreen Logs</p></TooltipContent>
                        </Tooltip>
                    </div>
                </div>}
