...
export default function UsageChart({ currency }: { currency: string }) {
    ...
    const formatCost = (v: number) =>
        new Intl.NumberFormat('en-US', { style: 'currency', currency: currency || 'CNY', maximumFractionDigits: 4 }).format(v);
            ...
            <CardContent>
                {loading ? (
                    ...
                    <div className="space-y-6">
                        {/* Cost chart */}
                        <div>
                            <p className="text-sm text-muted-foreground mb-2">Hourly Cost</p>
