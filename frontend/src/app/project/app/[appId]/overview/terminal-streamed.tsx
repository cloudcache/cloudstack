        ...
        <div className="space-y-4">
            {!sessionTerminalInfo ? <>
                <div className="flex gap-4">
                    <Button variant="secondary" onClick={() => startTerminalSession('sh')}>{t('app.terminal.startShell', { shell: 'sh' })}</Button>
                    <Button variant="secondary" onClick={() => startTerminalSession('bash')}>{t('app.terminal.startShell', { shell: 'bash' })}</Button>
                </div>
            </> : <Button variant="secondary" onClick={() => disconnectTerminalSession()}>{t('app.terminal.disconnect')}</Button>}
