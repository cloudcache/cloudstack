                ...
                <div className="w-full max-w-8xl px-4 lg:px-8">
                    <div className="flex h-16 items-center px-4">
                        <nav className="flex items-center space-x-4 lg:space-x-6 mx-6">
                            <Link href="/" className={pathname === '/' ? activeCss : inactiveCss}>{t('nav.projects')}</Link>
                            <Link href="/metrics" className={pathname.startsWith('/metrics') ? activeCss : inactiveCss}>{t('nav.metrics')}</Link>
                            <Link href="/settings/profile" className={pathname.startsWith('/settings') ? activeCss : inactiveCss}>{t('nav.settings')}</Link>
                        </nav>
